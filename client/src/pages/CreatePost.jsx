    ...
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[16px] max-w[500px]">
          DALL-E AI allows you to create and share imaginative and visually
          stunning images with the community.
        </p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button
            ...
            className="w-full text-white bg-green-700 font-medium rounded-md text-sm sm:w-auto px-24 py-2.5 text-center"
          >
